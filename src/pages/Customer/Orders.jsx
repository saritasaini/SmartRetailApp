...
const OrderCard = ({ order, index, setCancellingOrderId, setSelectedInvoice, setReorderOrder }) => {
    ...
    <div className="order-card">
        ...
        <div className="card-footer">
            ...
            <div className="footer-actions">
                ...
                <button className="order-btn order-btn-primary" onClick={() => setSelectedInvoice(order)}>
                    📄 View Invoice
                </button>
            </div>
        </div>
